...
When contributing to "Header and Footer Scripts Inserter" you have to follow some conventions and a simple workflow. It allows me to handle the requests quickly and ensure best quality
for the "Header and Footer Scripts Inserter" core code.
...
The preferred way to report bugs is to use the [GitHub issue tracker](https://github.com/ArthurGareginyan/header-and-footer-scripts-inserter/issues). Before reporting a bug, read these pointers.
...
- "Header and Footer Scripts Inserter" is maintained by me. I don't owe you anything, so be polite. Reports with an indignant or belligerent tone tend to be moved to the bottom of the pile.
...
- Mention which release of "Header and Footer Scripts Inserter" you're using.
...
- Fork [Header and Footer Scripts Inserter](https://github.com/ArthurGareginyan/header-and-footer-scripts-inserter)
...
By contributing code to "Header and Footer Scripts Inserter" you:
