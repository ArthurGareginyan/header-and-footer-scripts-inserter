...
function spacexchimp_p006_plugin_row_meta( $links, $file ) {
    ...
    if ( strpos( $file, SPACEXCHIMP_P006_SLUG . '.php' ) !== false ) {
        ...
        $new_links = array(
                           'donate' => '<a href="https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=8A88KC7TFF6CS" target="_blank"><span class="dashicons dashicons-heart"></span> ' . __( 'Donate', SPACEXCHIMP_P006_TEXT ) . '</a>'
                           );
...
function spacexchimp_p006_register_submenu_page() {
    $menu_title = SPACEXCHIMP_P006_NAME;
    $capability = 'manage_options';
    add_options_page( SPACEXCHIMP_P006_NAME, $menu_title, $capability, SPACEXCHIMP_P006_SLUG, 'spacexchimp_p006_render_submenu_page' );
}
