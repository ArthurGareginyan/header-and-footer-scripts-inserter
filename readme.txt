...
Easily add your scripts to the WordPress website's head or/and footer section. This is a must have tool for authors and website's owners.
...
After installation, a "`Header and Footer Scripts Inserter`" menu item will appear in the "`Settings`" section. Click on this in order to view plugin's administration page.
...
= Q. How does it work? =
A. First, go to page "`Settings`" —> "`Header and Footer Scripts Inserter`".
...
"Header and Footer Scripts Inserter" is one of the personal software projects of [Arthur Gareginyan](http://www.arthurgareginyan.com).
